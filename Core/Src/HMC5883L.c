...
{
	//HAL_I2C_Mem_Write_IT(&I2C, HMC5883L_DEFAULT_ADDRESS, reg, 1 , &value,1);
...
//  HAL_I2C_Mem_Write(&I2C, HMC5883L_ADDRESS, reg, 1 ,value,1,500)
    ...
    //HAL_I2C_Mem_Read_IT(&I2C, HMC5883L_DEFAULT_ADDRESS , reg, 1, &value, 1);
    return value;
}
...
{
    uint8_t value;
    //This function is used to write an amount of data in blocking mode
...
int16_t HMC5883L_readRegister16(uint8_t reg)
{
   ...
   // HAL_I2C_Mem_Read_IT(&I2C,  HMC5883L_DEFAULT_ADDRESS, reg, 1, vha, 2);
